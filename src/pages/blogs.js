    ...
    <>
      <div className="bg-black px-36">
        <div className="bg-new_black text-white  border-l border-[#29292C]">
          ...
          <Navbar />
          <br />
          <div class="ml-[-175px] max-w-sm w-full lg:max-w-full lg:flex">
            <div
              class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden"
              style={{ backgroundImage: "url('/img/card-left.jpg')" }}
              title="Woman holding a mug"
            ></div>
            <div class="border bg-inner_black border-gray-400  p-4 flex flex-col justify-between leading-normal">
              <div class="mb-8">
          ...
          <br />
          <br />
          <div class="mr-[-175px] max-w-sm w-full lg:max-w-full lg:flex">
            <div
              class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden"
              style={{ backgroundImage: "url('/img/card-left.jpg')" }}
              title="Woman holding a mug"

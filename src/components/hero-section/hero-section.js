    ...
    <>
      <div className="lg:px-32 lg:py-16 px-6 py-8">
        ...
        <h1 className="text-5xl font-bold">
          Anshuman Dhiman, founder <br /> developer and designer{" "}
        </h1>
        <br />
        <p className="lg:text-m lg:pr-[18rem] text-light_black">
          ...
          experimented with drones and founding the Aviation Club at his
          college, where he serves as Vice President. His diverse skill set and
          dedication make him a well-rounded professional.
        </p>
      </div>
      <div className="lg:px-28 px-6 text-light_black">
        <a
          href="https://github.com/AnshumanDhiman"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://www.instagram.com/anshuman.dhiman/"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://www.linkedin.com/in/anshuman-dhiman-06a7341ab/"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://medium.com/@anshumandhiman30"
          target="_blank"
          rel="noreferrer"
        >

              ...
              >
                ...
                <li className="py-4 flex">
                  <div className="p-6 rounded-3xl border-[1.5px] border-[#303032]">
                    ...
                    <p className="text-sm text-gray-500">
                      An interactive website that aims to empower students and
                      learners by providing comprehensive and accessible
                      educational resources. With a diverse range of e-learning
                      topics covered, the platform offers an extensive
                      collection of notes designed to facilitate the learning
                      process.
                    </p>
                    <a
                ...
                <li className="py-4 flex">
                  <div className="p-6 rounded-3xl border-[1.5px] border-[#303032]">
                    IPEC Connect
                    <p className="text-sm text-gray-500">
                      A Social Media platform for the students of Inderprastha
                      Engineering College.
                    </p>
                    <a
                      href="https://exchange.adobe.com/apps/cc/f7ecf6b5?pluginId=f7ecf6b5"
                ...
                <li className="py-4 flex">
                  <div className="p-6 rounded-3xl border-[1.5px] border-[#303032]">
                    ...
                    <p className="text-sm text-gray-500">
                      Developed a solution for hostel managementproviding
                      features for allocation of room to the, Reallocation of
                      room, no of rooms empty, no of students from a particular
                      institute in a particular hostel building etc.
                    </p>
